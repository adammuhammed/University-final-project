...
@include('sidebar')
      ...
      <div class="box">
        ...
        @endif
        <form method="post" action="{{ route('cert_show') }}?q=endor_ar" enctype='multipart/form-data'>
        @csrf
          <div class="form-box">
            <input type="text" name="date" required value="{{ old('date') }}">
            <label id="label-name">التأريخ</label>
          </div>
          <div class="form-box">
          ...
          <div class="form-box">
            ...
            <div class="form-box">
              ...
              <label>المعاون للشؤون العلمية والدراسات العليا</label>
            </div>
            <div class="form-box">
              <input type="text" name="ur" required value="{{ old('ur') }}">
              <label>مدير التسجيل</label>
            </div>
            <div class="form-box">
